...
Token is used to keep track of login authentication.

- [ ] What steps can you take in your web apps to keep your data secure?

Login authentication and having private routing.
...
Create = POST to a server sending a newly created Data
Read = GET
Update = PUT with an existing server
